 ...
 *
 * taken from: https://github.com/FasterXML/jackson-databind/blob/master/src/main/java/com/fasterxml/jackson/databind/util/ISO8601DateFormat.java
 * to avoid the dependency on jackson for muster-core
 *
 * @see ISO8601Utils
 */
