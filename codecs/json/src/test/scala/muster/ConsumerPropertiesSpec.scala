...
//      "read an option with option value, with missing as missing" ! optMissingMapProp ^ br ^
  ...
  val mapIntProp = Prop.forAll(intMapGen) { (i: Map[Int, Int]) =>
    val json = {
      val sb = new mutable.StringBuilder()
      sb.append('{')
      var first = true
  ...
  val mapIntListProp = Prop.forAll(intMapListGen) { (i: Map[Int, List[Int]]) =>
    val json = {
      val sb = new mutable.StringBuilder()
      sb.append('{')
      var first = true
  ...
  val mapLongProp = Prop.forAll(longMapGen) { (i: Map[Long, Int]) =>
    val json = {
      val sb = new mutable.StringBuilder()
      sb.append('{')
      var first = true
  ...
  val mapLongListProp = Prop.forAll(longMapListGen) { (i: Map[Long, List[Int]]) =>
    val json = {
      val sb = new mutable.StringBuilder()
      sb.append('{')
      var first = true
