...
//      read[Date]("\""+ds+"\"") must_== Muster.from.JsonString.dateFormat.parse(ds)
//    }
//
//    "read a symbol" in {
...
//
//    object ImplOverride {
//      implicit object ImplOverrideReadable extends Readable[ImplOverride] {
//        def readFormatted[R](source: R, inputFormat: InputFormat[R]): ImplOverride = {
//          read(inputFormat.createCursor(source).readObject())
//        }
//
//        def read(obj: ObjectNode): ImplOverride = ImplOverride(3854)
//      }
//    }
